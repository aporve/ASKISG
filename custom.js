(function injectJS() {
    try {        
        ...
        modularBars.src = 'https://aporve.github.io/ASKISG/addFrame.js';
...
function injectDynamicCssToParent() {
    ...
    var parentCssStyles = '#ymFrameHolder { width: 100%;} @media only screen and (min-width: 768px) { #ymFrameHolder { width: 440px; } #chatContainer {background: orange ; color:blue}}';
        ...
        if(eventData.data == 'Maxamize') {
            (function injectJS() {
                try {        
                    ...
                    var parentCssStyles = '#ymFrameHolder { width: 100%; } @media only screen and (min-width: 768px) { #ymFrameHolder { width: 880px; } html #emailModal #chatBoxMain { z-index: 1;background: orange;}} } }';
                    if (parentStyles.styleSheet) {
                    parentStyles.styleSheet.cssText = parentCssStyles;
                    } else {
                    parentStyles.appendChild(document.createTextNode(parentCssStyles));
