        ...
        if(eventData.data == 'Maxamize') {
            (function injectJS() {
                try {        
                    ...
                    var parentCssStyles = '#ymFrameHolder { width: 100%; } @media only screen and (min-width: 768px) { #ymFrameHolder { width: 880px; } , .card_title {background:orange} } }';
                    if (parentStyles.styleSheet) {
                    parentStyles.styleSheet.cssText = parentCssStyles;
                    } else {
                    parentStyles.appendChild(document.createTextNode(parentCssStyles));
        ...
        if(eventData.data == 'MINIMIZE') {
            (function injectJS() {
                try {        
                    ...
                    var parentCssStyles = '#ymFrameHolder { width: 100%; } @media only screen and (min-width: 768px) { #ymFrameHolder { width: 440px; } , .card_title {background:red} }}';
                    if (parentStyles.styleSheet) {
                    parentStyles.styleSheet.cssText = parentCssStyles;
                    } else {
                    parentStyles.appendChild(document.createTextNode(parentCssStyles));
