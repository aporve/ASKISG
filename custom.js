...
function injectDynamicCssToParent() {
    ...
    var parentCssStyles = '#ymFrameHolder { width: 100%;} @media only screen and (min-width: 768px) { #ymFrameHolder { width: 440px; } #chatBoxMain { z-index: 1;background: orange;}}';
